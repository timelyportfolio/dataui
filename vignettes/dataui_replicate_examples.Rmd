...
I should note that our sparklines automatically include tooltip behaviors, since it is impossible (or nearly impossible) to unlock these from R.  If `responsive=TRUE`, then the charts become responsive to changes in width of the parent container.
...
function (_ref) {
  ...
  width = "50%",  # to prove these are responsive unlike the data-ui examples
  height = 100,
  responsive = TRUE, # also need to specify responsive
