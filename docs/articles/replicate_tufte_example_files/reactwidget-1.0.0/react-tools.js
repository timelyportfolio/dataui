...
function hydrate(components, tag) {
  ...
  var react_el = React.createElement.apply(React, args);
  var props = Object.assign({}, react_el.props);
  Object.keys(props).forEach(function (ky) {
    var prop = props[ky];

    if (typeof prop === "function") {
      prop = prop.bind(props);
    }
  });
  return React.cloneElement(react_el, props);
}
var defaultOptions = {
